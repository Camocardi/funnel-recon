...
VID_A = "81d625dd-b729-4291-9176-b1b5e1565068"
VID_B = "99999999-aaaa-bbbb-cccc-000000000000"

VSL = f'''<html><head><title>main</title></head><body>
<script>fbq("init","3248264035336938");</script>
<vturb-smartplayer id="vid-x">
<script src="https://scripts.converteai.net/acc/players/pl">
https://cdn.converteai.net/{VID_A}/main/video.m3u8</script>
